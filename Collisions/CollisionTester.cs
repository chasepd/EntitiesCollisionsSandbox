...
namespace EntitiesCollisionsSandbox.Collisions
{
    ...
    {
        public static bool AabbAabb(AxisAlignedBoundingBox a, AxisAlignedBoundingBox b)
        {
        ...
        public static bool AabbAabb(AxisAlignedBoundingBox aBox, AxisAlignedBoundingBox bBox, Vector2 vector, out Manifold manifold)
        {
